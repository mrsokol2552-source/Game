...
// [CODE-ID: SCRIPTS-PRESENTATION-VIEW-DIRECTIONALANIMATIONSET]
// Logical block: Scripts/Presentation/View/DirectionalAnimationSet.
...
namespace Game.Presentation.View
{
    ...
    public class DirectionalAnimationSet : ScriptableObject
    {
        ...
        [Min(0.1f)]
        public float CrouchIdleFps = 6f;
        [Min(0.1f)]
        public float CrouchRunFps = 10f;
        ...
        public Sprite[] CrouchIdleFrames;
        public Sprite[] CrouchRunFrames;
